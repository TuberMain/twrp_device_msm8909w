...
PRODUCT_BRAND := XTC
PRODUCT_MODEL := XTC_Z2y
PRODUCT_MANUFACTURER := xtc

PRODUCT_GMS_CLIENTID_BASE := android-xtc

PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="msm8909w-user 7.1.1 NMF26F eng.root.20191218.225950 release-keys"

BUILD_FINGERPRINT := XTC/msm8909w/msm8909w:7.1.1/NMF26F/root12182259:user/release-keys
